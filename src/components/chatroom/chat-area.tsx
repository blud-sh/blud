...
const initialMessages = [
    {
        ...
        content:
            "Hey everyone! Just joined the server. I'm a CS major, second year. Anyone working on any cool projects?",
    ...
    },
    {
        ...
        avatar: "/placeholder.svg?height=40&width=40",
        content:
            "Has anyone taken Professor Wilson's AI course? Thinking about enrolling next semester.",
    ...
    },
    {
        ...
        avatar: "/placeholder.svg?height=40&width=40",
        content:
            "I took it last year! It's challenging but definitely worth it. The final project is super interesting.",
                    ...
                    <div key={date} className="space-y-4">
                        ...
                        {dateMessages.map((message, index) => {
                            const isNewMessageGroup =
                                index === 0 || message.isNew !== dateMessages[index - 1].isNew
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="bg-slate-50 rounded-2xl p-2 shadow-sm border border-slate-200">
                        <textarea
                            ...
                            className="min-h-[60px] w-full border-0 focus:outline-none focus:ring-0 bg-transparent resize-none text-slate-700 placeholder:text-slate-400 p-2"
                            style={{ outline: "none" }}
                        />
