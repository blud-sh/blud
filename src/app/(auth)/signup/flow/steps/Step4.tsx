    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-[#f1f8f4] text-black font-sans">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4">
                <h1 className="text-5xl md:text-6xl font-bold text-contrast font-primary mt-16 mb-10 text-center">
                    a little more about you…
                </h1>
                <div className="flex flex-col md:flex-row gap-6 w-full max-w-2xl mb-8 mx-auto">
                    {/* Name input */}
                    <div className="flex-1 flex flex-col">
                        <label className="mb-2 font-medium text-2xl font-primary" htmlFor="name">
                            what is your name?
                        </label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full min-w-[400px] max-w-2xl pl-14 pr-8 py-5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7A69B3] text-lg font-secondary text-text-grey-2"
                    ...
                    <div className="flex-1 flex flex-col mt-6 md:mt-0">
                        <label
                            className="mb-2 font-medium text-2xl font-primary"
                            htmlFor="username"
                        >
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full min-w-[400px] max-w-2xl pl-14 pr-8 py-5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7A69B3] text-lg text-text-grey-2 font-secondary"
                ...
                <div className="w-full max-w-2xl flex flex-col mb-8 mx-auto">
                    <label className="mb-2 font-medium text-2xl font-primary" htmlFor="bio">
                    ...
                    <textarea
                        ...
                        className="block w-full min-w-[400px] max-w-2xl min-h-[160px] rounded-lg border border-gray-300 focus:border-[#7A69B3] focus:ring-2 focus:ring-[#7A69B3] outline-none text-lg bg-white p-5 resize-none font-secondary text-text-grey-2"
